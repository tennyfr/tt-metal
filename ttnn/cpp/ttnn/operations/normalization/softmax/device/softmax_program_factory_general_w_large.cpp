...
// KNOWN ISSUE — committed then reverted: this factory borrows the shared moreh_softmax_w_large.cpp
// compute kernel, whose Metal 2.0 port fails to JIT-compile in the fp32_dest_acc_en path (out-of-scope
// LLK addrmod "impossible constraint in 'asm'"). See METAL2_PORT_REPORT.md. Kept in git history so the
