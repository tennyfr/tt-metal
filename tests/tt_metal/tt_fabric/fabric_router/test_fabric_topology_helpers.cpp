...
TEST(FabricTopologyHelpers, TorusDeadlockAvoidanceUsesDeclaredTorusAxes) {
    EXPECT_TRUE(requires_torus_deadlock_avoidance(FabricType::TORUS_Y, eth_chan_directions::NORTH));
    EXPECT_TRUE(requires_torus_deadlock_avoidance(FabricType::TORUS_Y, eth_chan_directions::SOUTH));
    EXPECT_FALSE(requires_torus_deadlock_avoidance(FabricType::TORUS_Y, eth_chan_directions::EAST));
    EXPECT_TRUE(requires_torus_deadlock_avoidance(FabricType::TORUS_X, eth_chan_directions::EAST));
    EXPECT_TRUE(requires_torus_deadlock_avoidance(FabricType::TORUS_X, eth_chan_directions::WEST));
    EXPECT_FALSE(requires_torus_deadlock_avoidance(FabricType::TORUS_X, eth_chan_directions::NORTH));
    EXPECT_TRUE(requires_torus_deadlock_avoidance(FabricType::TORUS_XY, eth_chan_directions::Z));
    EXPECT_FALSE(requires_torus_deadlock_avoidance(FabricType::MESH, eth_chan_directions::Z));
}
