...
bool requires_torus_deadlock_avoidance(FabricType fabric_type, eth_chan_directions direction) {
    if (direction == eth_chan_directions::NORTH || direction == eth_chan_directions::SOUTH) {
        return has_flag(fabric_type, FabricType::TORUS_Y);
    }
    if (direction == eth_chan_directions::EAST || direction == eth_chan_directions::WEST) {
        return has_flag(fabric_type, FabricType::TORUS_X);
    }
